			...
			<div className={styles.wrapper}>
				...
				<div className={styles.itemContainer}>
					<div className={cn(styles.item, styles.gridItem1)}>
						<Image  quality={100} loading='lazy' src={ProfessionalismIcom} alt='Безупречность и профессионализм' className={styles.icon}/>
					...
					<div className={cn(styles.item, styles.gridItem2)}>
						<Image  quality={100} loading='lazy' src={OpennessIcon} alt='Открытость и честность' className={styles.icon}/>
					...
					<div className={cn(styles.item, styles.gridItem3)}>
						<Image  quality={100} loading='lazy' src={EcoIcon} alt='Экономичность' className={styles.icon}/>
					...
					<div className={cn(styles.item, styles.gridItem4)}>
						<Image  quality={100} loading='lazy' src={ReliabilityIcon} alt='Надежность и своевременность' className={styles.icon}/>
